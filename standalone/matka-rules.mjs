...
export const allSinglePannas = [...new Set(pannaEntries.flatMap(([, pannas]) => pannas))].sort();
export const allCardPannas = [...new Set(sattaEntries.flatMap(([, pannas]) => pannas))].sort();
export const allDoublePannas = allCardPannas.filter((panna) => !allSinglePannas.includes(panna) && !allTriplePannas.includes(panna));
